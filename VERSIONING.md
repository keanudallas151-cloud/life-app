...
- Git tag: `v0.7.1`
- GitHub release title: `v0.7.1 - Firebase hardening and communication templates`
...
The current `main` branch should be treated as the `v0.7.1` prototype baseline, with `main_backup` kept aligned as the backup branch.
